...
class TopNewsScreen extends ConsumerStatefulWidget {
...
class _TopNewsScreenState extends ConsumerState<TopNewsScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      ref.read(newsProvider.notifier).loadDiscoveryNews('top_news');
    });
  }
