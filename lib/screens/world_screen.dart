...
class WorldNewsScreen extends ConsumerStatefulWidget {
...
class _WorldNewsScreenState extends ConsumerState<WorldNewsScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      ref.read(newsProvider.notifier).loadDiscoveryNews('world');
    });
  }

  Future<void> _refreshNewsData() async {
    await ref.read(newsProvider.notifier).loadDiscoveryNews('world');
  }
